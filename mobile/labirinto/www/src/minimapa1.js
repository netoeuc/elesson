...
//        this.addChild(loadingErrorButton, 12);
        ...
        if(status < 21){
            ...
            xhr.open( "POST", apiURL+"api/student/questions" );
...
//            var sp2 = new cc.Sprite.create(asset.Mini_mapa3_png); 
            ...
            switch(status){
                ...
                case '21':
//                    topMenu.SetLocalZOrder(501);
//                    btnVoltar.SetLocalZOrder(502);
                    var sp2 = new cc.Sprite.create(asset.tela_fim_jogo_png);
                    sp2.setAnchorPoint(cc.p(0,0));
                    sp2.setPosition(cc.p(0,0));
                    this.addChild(sp2, 500);  
                    
                    //adicionando o botão de voltar ao mapa global
                    var btnBack = new ccui.Button();
                    btnBack.loadTextures(asset.pause_accept_png);
                    btnBack.setAnchorPoint(cc.p(0,0));
                    btnBack.setPosition(cc.p(162,80));
                    btnBack.addTouchEventListener(this.voltar, this); //pop
                    this.addChild(btnBack, 505); //tag = 888
